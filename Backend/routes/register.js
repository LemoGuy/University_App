...
router.post('/', (req, res) => {
    ...
    //     errors.push({ msg: 'Password should be at leat 6 charcters' });
    // }

    // // TODO!! REGISTER HAVE TO RES>SEND SOMETHING
    // if (errors.length > 0) {
...
router.get('/', (req, res) => {
    ...
    res.render('register.ejs', {role})
});


// TODO !! flash for giving a message to frontend user for 5s.
